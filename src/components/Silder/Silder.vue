    ...
    <nav class="ynet-silder-sidebar">
      <ul class="ynet-silder-nav">
        <template v-for="(itemPar,p) in routes">
          <li class="ynet-silder-nav-item" v-if="!itemPar.hidden&&!itemPar.children">
            <router-link
              :to="itemPar.path"
              :class="['ynet-silder-nav-link',itemPar.children?'ynet-silder-nav-link-toggle':'']"
              exact
            >
          ...
          >
            ...
            <ul class="ynet-silder-nav-dropdown">
              <template v-for="(itemChi,c) in itemPar.children">
                <li class="ynet-silder-nav-item" v-if="!itemChi.hidden&&!itemChi.children">
                  <router-link
                    :to="itemPar.path+'/'+itemChi.path"
                    :class="['ynet-silder-nav-link',itemChi.children?'ynet-silder-nav-link-toggle':'']"
                    exact
                  >
                    <span class="ynet-silder-icon">
                ...
                >
                  ...
                  <ul class="ynet-silder-nav-dropdown">
                    <template v-for="(itemGro,g) in itemChi.children">
                      <li class="ynet-silder-nav-item" v-if="!itemGro.hidden&&!itemGro.children">
                        <router-link
                          :to="itemPar.path+'/'+itemChi.path+'/'+itemGro.path"
                          :class="['ynet-silder-nav-link',itemGro.children?'ynet-silder-nav-link-toggle':'']"
                          exact
                        >
                          <span class="ynet-silder-icon">
